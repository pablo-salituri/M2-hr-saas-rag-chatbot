...
def suspicious_input_detected(question: str) -> bool:
    """
    Detects obvious prompt-injection patterns in user input.
    Returns True if a blocked pattern is found, False otherwise.
    """
...
def validate_question(question: str) -> tuple[bool, str | None]:
    """
    Validates the user input before retrieval and generation.
